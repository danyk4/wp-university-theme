...
while ( have_posts() ) {
    ...
    <div class="container container--narrow page-section">
        <div class="create-note">
            ...
            <textarea class="new-note-body" name="body" id="" cols="30" rows="10"
                      placeholder="Your note here..."></textarea>
            <span class="submit-note">Create Note</span>
            <span
                class="note-limit-message">Note limit reached: delete an existing note to make a room for a new one.</span>
        </div>
